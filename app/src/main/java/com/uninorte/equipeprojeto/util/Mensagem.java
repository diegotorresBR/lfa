package com.uninorte.equipeprojeto.util;
...
public class Mensagem {
    ...
    public static void MsgCurta(Activity activity, String msg){
        Toast.makeText(activity, msg, Toast.LENGTH_SHORT).show();
    }

//    public static void Msg(Fragment fragment, String msg){
//        Toast.makeText(fragment, msg, Toast.LENGTH_LONG).show();
//    }
